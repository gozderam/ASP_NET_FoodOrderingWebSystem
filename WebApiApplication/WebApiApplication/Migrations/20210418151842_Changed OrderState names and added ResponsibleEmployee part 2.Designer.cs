...
namespace WebApiApplication.Migrations
{
    ...
    [Migration("20210418151842_Changed OrderState names and added ResponsibleEmployee part 2")]
    partial class ChangedOrderStatenamesandaddedResponsibleEmployeepart2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuPositionOrder", b =>
                {
                    ...
                    b.HasKey("MenuPositionsId", "OrdersId");

                    b.HasIndex("OrdersId");

                    b.ToTable("Orders_MenuPositions");
                });
            ...
            modelBuilder.Entity("MenuPositionOrder", b =>
                {
                    b.HasOne("WebApiApplication.Database.POCO.MenuPosition", null)
                        .WithMany()
                        .HasForeignKey("MenuPositionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApiApplication.Database.POCO.Order", null)
                        .WithMany()
